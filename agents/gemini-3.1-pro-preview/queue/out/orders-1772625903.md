...
Read and complete the workorder in: workorders/wip/P0_opus_fix_pr_18_rejection.md
...
FIRST THING you do:
```bash
python bin/next_step workorders/wip/P0_opus_fix_pr_18_rejection.md START
```

AS YOU WORK, journal before each action:
```bash
python bin/next_step workorders/wip/P0_opus_fix_pr_18_rejection.md "reading config.py to understand ConfigManager"
# then do the reading

python bin/next_step workorders/wip/P0_opus_fix_pr_18_rejection.md "implementing enable/disable commands"
# then do the coding

python bin/next_step workorders/wip/P0_opus_fix_pr_18_rejection.md "writing tests in tests/test_foo.py"
# then write tests
```

WHEN DONE:
```bash
python bin/next_step workorders/wip/P0_opus_fix_pr_18_rejection.md COMPLETE
```
...
1. Read workorders/wip/P0_opus_fix_pr_18_rejection.md for your task instructions
...
7. `python bin/next_step workorders/wip/P0_opus_fix_pr_18_rejection.md COMPLETE`
