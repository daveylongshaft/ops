...
- **Task file**: `C:/csc/ops/wo/wip/upgrade_server.md` — read this for your task. Write journal + COMPLETE here.

## ORIENTATION

1. Read your task: `C:/csc/ops/wo/wip/upgrade_server.md`
...
6. `echo "COMPLETE" >> C:/csc/ops/wo/wip/upgrade_server.md`

## MANDATORY: JOURNAL TO WIP FILE

FIRST THING you do:
```bash
echo "START" >> C:/csc/ops/wo/wip/upgrade_server.md
```

AS YOU WORK, before each action:
```bash
echo "reading config.py" >> C:/csc/ops/wo/wip/upgrade_server.md
echo "implementing X" >> C:/csc/ops/wo/wip/upgrade_server.md
```

WHEN DONE:
```bash
echo "COMPLETE" >> C:/csc/ops/wo/wip/upgrade_server.md
```
...
- Journal EVERY step with `echo "step" >> C:/csc/ops/wo/wip/upgrade_server.md`
