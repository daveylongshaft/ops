...
reading config, infra, and other key files
reading infra files
reading shared services and looking for missing files
checking for import cascades and security issues
analyzing security and completeness issues
checking .pyc files in PR
writing review and posting
posting pr review
review posted, marking complete
COMPLETE
